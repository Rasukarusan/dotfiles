...
export FZF_DEFAULT_OPTS='--color=fg+:11 --height 70% --hidden --follow --reverse --select-1 --exit-0 --multi'
...
alias rtm='_redmineToMarkdown'
alias mtr='_markdownToRedmine'
